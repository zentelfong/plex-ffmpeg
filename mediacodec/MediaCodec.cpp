...
#define NativeCodec_LOGI(...) __android_log_print(ANDROID_LOG_INFO , "MediaCodec", __VA_ARGS__)
#define NativeCodec_LOGE(...) __android_log_print(ANDROID_LOG_ERROR , "MediaCodec", __VA_ARGS__)
...
{ "AMediaFormat_setFloat", OFF(_setFloat), true },
...
{
	return gdlsys.AMediaFormat._setFloat(format, name, value);
}
